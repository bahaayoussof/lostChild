...
import com.lost.child.service.mapper.AddressMapper;
...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().street(DEFAULT_STREET).city(DEFAULT_CITY).state(DEFAULT_STATE).country(DEFAULT_COUNTRY);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().street(UPDATED_STREET).city(UPDATED_CITY).state(UPDATED_STATE).country(UPDATED_COUNTRY);
        return address;
    }
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.street(UPDATED_STREET).city(UPDATED_CITY).state(UPDATED_STATE).country(UPDATED_COUNTRY);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.city(UPDATED_CITY).state(UPDATED_STATE).country(UPDATED_COUNTRY);
