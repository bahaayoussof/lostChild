...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './last-seen.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LASTSEEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_LASTSEEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LASTSEEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LASTSEEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LASTSEEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LASTSEEN actions', async () => {
      const expectedActions = [
        {
