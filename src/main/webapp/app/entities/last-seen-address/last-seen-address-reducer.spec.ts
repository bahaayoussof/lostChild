...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './last-seen-address.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LASTSEENADDRESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LASTSEENADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LASTSEENADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LASTSEENADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LASTSEENADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LASTSEENADDRESS actions', async () => {
      const expectedActions = [
        {
